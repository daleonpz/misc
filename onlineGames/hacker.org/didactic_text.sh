...
# Challenge 'Didactic Text' [Crypto]

# original
o=" Four score and seven years ago our fathers brought forth on this continent, a new nation, conceived in Liberty, and dedicated to the proposition that all men are created equal.
...
# hacker.org
h=" Four score and seven years ago our fathers brought forth on this continent, a new nation, conceived in Liberty, and dedicated to the proposition that all the men are created equal.
...
diff -u o.file h.file | grep "[-\+][a-z]" | sed "s/,//;s/\.//g" 
