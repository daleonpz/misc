...
public class AtomicIntegerExample_original {
	...
	static class MyRunnable implements Runnable {
		...
		public void run() {
			...
			System.out.println("Thread " + Thread.currentThread().getId() + " / Counter : " + this.myCounter);
			this.myPrevCounter = at.getAndIncrement();
			System.out.println("Thread " + Thread.currentThread().getId() + " / Previous : " + this.myPrevCounter);
			this.myCounterPlusFive = at.addAndGet(5);
			System.out.println("Thread " + Thread.currentThread().getId() + " / plus five : " + this.myCounterPlusFive);
