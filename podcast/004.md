...
0. Que tan buena/o eres manejando tu dinero. Antes del covid. Tu ahorrabas? te sentias segura economicamente? 

1. Datos sobre el ahorro en el Peru
...
Veamos como ha cambiado este comportamiento durante la pandemia
...
- Pregunta: En tu vida, como ha cambiado tu manejo del dinero desde que comenzo la pandemia. 
  

- Pregunta: Como crees que ahorran los peruanos y para que ahorran? 

Los peruanos ahorran asi: 
52.23% ahorran 
...
- Pregunta: Ahorrar siempre es bueno y sus ventajas son claras. Pero realmente hace una diferencia el como se hace? es decir, mas alla del aspecto de seguridad. Un banco  es mas seguro que mantenerlo bajo el colchon.  En el Peru hay muchas opciones, cuenta de ahorros, juntas, acumular en una caja fuerte o sittio que tu consideras seguro en tu casa, afp con aportes voluntarios. 
...
> el valor del tiempo en el dinero: la inflacion come tu dinero.
> El ahorro como Inversion > Rentabilidad
> comisiones 

- Pregunta: Si gano poco, no puedo darme el lujo de ahorrar. 
  - Cambio de estilo de vida
  - Trackear o monitorear los gastos
  - Disfrutar el dinero tmb. 
...
Dar un ejemplo de como ahorraba ganando 480 soles como estudiante. Como ahorraba cuando ganaba 2500 como ingeniero. 

Hablar del libro "El hombre mas rico de babilonia"
...
Entender que el ahorro es una actitud, hay gente que gana mucho pero no ahorra. "cuando tenga mas dinero, voy a poder ahorrar" > eso no pasa porque no tienes la costumbre. lo que suele pasar es que comienzas a gastar mas.

> una regla general es ahorrar e invertir.

- Pregunta: en que invertir...
    el objetivo de invertir es basicamente obtener una ganancia. Experiencias, salud, conocimiento, dinero.
    Estudiar
    Viajar


 Dejamos mas links en las notas del show. 
===============================

- El Peru o en general latinoamerica es una zona de emprendedores.  La escuela de administracion de negocios Essan tiene una publicacion que se llama "Monitoreo de emprendimiento Global". Alli uno encuentra estadisticas sobre el emprendimiento en el mundo. En Peru uno de cada 4 tiene un negocio propio en etapa temprana. O sea un negocio con no mas de 3 anhos y medio. 
